...
class CustomerController extends Controller
{
    ...
    public function show($e_id)
    {
        if (Auth::user()->can('customer show'))
        {
            ...
            return view('account::customer.show', compact('customer','customFields'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function statement(Request $request, $id)
    {
        ...
        return view('account::customer.statement', compact('customer','user','customerDetail','invoice_payment','data'));
    }
