        ...
        <div class="invoice-header">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px; color: {{$color}};">{{ __('PURCHASE')}}</h3>
                            <table class="no-space">
                                <tbody>
                                    ...
                                    @foreach($customFields as $field)
                                        <tr>
                                            <td>{{$field->name}} :</td>
                                            <td class="text-right" style="white-space: normal;"> {{!empty($purchase->customField)?$purchase->customField[$field->id]:'-'}}</td>
                                        </tr>
                                    @endforeach
                                @endif
                                </tbody>
