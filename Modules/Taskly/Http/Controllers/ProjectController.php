    ...
    */
        ...
        foreach($request->clients as $client_id)
        {
            ...
            if(!empty(company_setting('Project Assigned')) && company_setting('Project Assigned')  == true)
            {
                try
                {
                    ...
                    {
                        $smtp_error = __('hello sdfsfdsfdfgfg');
                    }
                }
                catch(\Exception $e)
                {
    ...
    public function ProjectSharedLink($id = null,$lang = null)
    {
        ...
        if ($project)
        {
            ...
            return view('taskly::projects.sharedlink', compact('company_id','workspace_id','project','id','lang','chartData','daysleft','stages','bug_stages','invoices'));
