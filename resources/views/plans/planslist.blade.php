        ...
        <div class="button-tab-wrapper">
            ...
            <div class="custome-design-tab">
                <label for="custome_package">
                    <h5>{{ __('Custome Design Package') }}</h5>
                </label>
                <div class="form-check form-switch custom-switch-v1 float-end">
                                        ...
                                        <div class="basic-plan text-center mb-4">
                                            ...
                                            <ul class="plan-info">
                                                <li>
                                                    ...
                                                    <span>{{ __('Max User :') }}
                                                        <b>{{ !empty($single_plan->number_of_user) ? $single_plan->number_of_user : 0 }}</b></span>
                                                </li>
                                                <li>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8"
                                                        viewBox="0 0 9 8" fill="none">
                                                    ...
                                                    <span>{{ __('Max Workspace :') }}
                                                        <b>{{ !empty($single_plan->number_of_workspace) ? $single_plan->number_of_workspace : 0 }}</b></span>
                                                </li>
                                                <li>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8"
                                                        viewBox="0 0 9 8" fill="none">
